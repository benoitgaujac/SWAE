...
config_mnist['print_every'] = 120 #250
...
# Experiment set up
config_mnist['train_dataset_size'] = 12000
...
config_mnist['correct_for_extra_diagonal'] = True # Correct for extradiagonall term of the MMD
config_mnist['lambda'] = 3000.
...
config_mnist['sigma_prior'] = pow(.4,2)
