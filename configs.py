...
config_mnist['save_every_epoch'] = 101
config_mnist['print_every'] = 5
...
config_mnist['train_dataset_size'] = 200
config_mnist['epoch_num'] = 20
...
config_mnist['e_num_filters_g'] = 512
config_mnist['e_num_layers_g'] = 2
config_mnist['e_arch_g'] = 'dcgan' # mlp, dcgan, ali, began
config_mnist['e_num_filters_d'] = 1024
config_mnist['e_num_layers_d'] = 4
...
config_mnist['mmd_kernel'] = 'RBF' # RBF, IMQ
